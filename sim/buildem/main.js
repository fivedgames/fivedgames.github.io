...
var STATIC_BASE = 1024,
    ...
    STACKTOP = STACK_BASE,
    STACK_MAX = 208480,
    DYNAMIC_BASE = 5451360,
    DYNAMICTOP_PTR = 207552;
...
// {{PRE_LIBRARY}}
  ...
  var __main_thread_futex_wait_address=208464;function _emscripten_futex_wake(addr, count) {
  ...
  function __cleanup_thread(pthread_ptr) {
      ...
      if (pthread) {
        ...
        PThread.mainThreadBlock = 207712;
